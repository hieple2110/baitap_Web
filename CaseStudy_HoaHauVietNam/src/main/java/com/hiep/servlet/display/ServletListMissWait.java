...
@WebServlet(name = "ServletListMissWait", urlPatterns = "/listMissWait")
public class ServletListMissWait extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            List<Miss> listMiss = missService.listMissCho();
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("display/listMissWait.jsp");
