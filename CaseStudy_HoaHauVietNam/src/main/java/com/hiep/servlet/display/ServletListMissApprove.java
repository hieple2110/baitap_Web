...
@WebServlet(name = "ServletListMissApprove", urlPatterns = "/listMissApprove")
public class ServletListMissApprove extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            List<Miss> listMiss = missService.listMissDuyet();
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("display/listMissApprove.jsp");
