...
@WebServlet(name = "ServletPostMiss" ,urlPatterns = "/postsMiss")
public class ServletPostMiss extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("display/postsMiss.jsp");
