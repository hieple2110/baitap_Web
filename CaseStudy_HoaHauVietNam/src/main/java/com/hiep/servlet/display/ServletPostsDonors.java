...
@WebServlet(name = "ServletPostsDonors", urlPatterns = "/postsDonors")
public class ServletPostsDonors extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("display/postsDonors.jsp");
