...
@WebServlet(name = "ServletAddEducation", urlPatterns = "/addEducation")
public class ServletAddEducation extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.setAttribute("message",this.educationService.insert(education));
