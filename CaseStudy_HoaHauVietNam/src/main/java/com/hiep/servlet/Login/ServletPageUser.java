...
@WebServlet(name = "ServletPageUser",urlPatterns = "/pageUser")
public class ServletPageUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("login/pageUser.jsp");
