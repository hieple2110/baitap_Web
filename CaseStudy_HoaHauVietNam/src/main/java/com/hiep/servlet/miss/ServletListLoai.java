...
@WebServlet(name = "ServletListLoai", urlPatterns = "/biLoai")
public class ServletListLoai extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            List<Miss> listMiss = this.missService.listMissLoai();
            request.setAttribute("listMiss",listMiss);

            RequestDispatcher dispatcher = request.getRequestDispatcher("miss/biLoai.jsp");
