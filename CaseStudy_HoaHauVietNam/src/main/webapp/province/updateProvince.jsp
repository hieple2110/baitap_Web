                        ...
                        <li class="nav-item dropdown open" style="padding-left: 15px;">
                            <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true"
                               ...
                               data-toggle="dropdown" aria-expanded="false">
                                <span>
                                    <img src="<c:url value="${sessionScope.account.image}"/>" alt=" ">${sessionScope.account.userName}
                                </span>
                            </a>
            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="x_content">
                            <a href="/listProvince"><span class="section"><small>Back List Province</small></span></a>
                            <form action="/updateProvince" method="post">
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align"><span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" name="id"
                                               value="${province.idProvince}" type="hidden" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Name Province<span
                                            class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="5" name="name"
                                               value="${province.nameProvince}" type="text" required="required"/>
                                    </div>
                                </div>
                                <div class="ln_solid">
