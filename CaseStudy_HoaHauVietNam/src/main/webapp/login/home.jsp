        ...
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarMenu">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="/hoahauvietnam.com.vn">Trang chủ</a>
                    </li>
                            ...
                            <c:if test="${sessionScope.account != null }">
                                <c:choose>
                                    <c:when test="${sessionScope.account.decentralization.equals('user')}">
                                        <a class="dropdown-item" href="/listPosts">Quản lý Bài viết</a>
                                        <a class="dropdown-item" href="/logout">Đăng xuất</a>
                                    </c:when>
                                    <c:when test="${sessionScope.account.decentralization.equals('admin')}">
                                        <a class="dropdown-item" href="/listAccount">Quản lý Tài Khoản</a>
                                        <a class="dropdown-item" href="/listPosts">Quản lý Bài Viết</a>
                                        <a class="dropdown-item" href="/listMiss">Quản lý Thí Sinh</a>
                                        <a class="dropdown-item" href="/listCategory">Quản lý Thể Loại Bài viết</a>
                                        <a class="dropdown-item" href="/listProvince">Quản lý Tỉnh Thành</a>
                                        <a class="dropdown-item" href="/listNation">Quản lý Dân Tộc</a>
                                        <a class="dropdown-item" href="/listEducation">Quản lý Học Vấn</a>
                                        <a class="dropdown-item" href="/logout">Đăng xuất</a>
                                    </c:when>
                                </c:choose>
                            </c:if>
                               ...
                               style="background-image: url('${post.image}'); ">
                                <div class="text half-to-full">
                                    <div class="post-meta">
                                        ...
                                        <span class="ml-2"><span class="fa fa-eye"></span>${post.view}</span>
                                        <span class="ml-2"><span class="fa fa-thumbs-up"></span>${post.like}</span>
                                    </div>
                                    <h3>${post.title}</h3>
