            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="x_content">
                            <a href="/listMiss"><span class="section"><small>Back List Miss</small></span></a>
                            <form action="/updateMiss" method="post">
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align"><span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" name="id"
                                               value="${miss.idMiss}" type="hidden" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Date<span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="5" name="date"
                                               value="${miss.dateOfBirth}" type="date" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" name="address"
                                               type="text"
                                               value="${miss.address}" required="required"/>
                                    </div>
                                </div>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" name="job"
                                               value="${miss.job}" type="text" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" name="phone"
                                               type="text"
                                               value="${miss.numberPhone}" required="required"/>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                      <select name="province" class="form-control">
                                            <c:forEach items="${listProvince}" var="province">
                                                <c:if test="${miss.idProvince == province.idProvince}">
                                                    <option selected
                                                            value="${province.idProvince}">${province.nameProvince}</option>
                                                </c:if>
                                                <c:if test="${miss.idProvince != province.idProvince}">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="nation" class="form-control">
                                            <c:forEach items="${listNation}" var="nation">
                                                <c:if test="${miss.idNation == nation.idNation}">
                                                    <option selected
                                                            value="${nation.idNation}">${nation.nameNation}</option>
                                                </c:if>
                                                <c:if test="${miss.idNation != nation.idNation}">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="education" class="form-control">
                                            <c:forEach items="${listEducation}" var="education">
                                                <c:if test="${miss.idEducational == education.idEducational}">
                                                    <option selected
                                                            value="${education.idEducational}">${education.nameEducational}</option>
                                                </c:if>
                                                <c:if test="${miss.idEducational != education.idEducational}">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" name="image"
                                               value="${miss.image}" type="text" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Status<span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="4" name="status"
                                               value="${miss.status}" type="text" required="required"/>
                                    </div>
                                </div>
