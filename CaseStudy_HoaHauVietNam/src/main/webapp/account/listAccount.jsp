                                    ...
                                    <table class="table table-striped jambo_table bulk_action">
                                        ...
                                        <c:forEach var="account" items="${listAccount}">
                                            <tr class="even pointer">
                                                <td> <img src="<c:out value="${account.image}" />" height="100px" width="120px"></td>
                                                <td><c:out value="${account.userName}"/></td>
                                                <td><c:out value="${account.fullName}"/></td>
                                                <td><c:out value="${account.email}"/></td>
                                                <td>
                                                    <a href="/viewAccount?idAccount=${account.idAccount}"><i
                                                            style="color: #6ce26c" class="fa fa-eye"></i> || </a>
                                                    <a href="/updateAccount?idAccount=${account.idAccount}"><i
                                                            style="color: #007bff"
                                                            class="fa fa-cogs"></i> || </a>
                                                    <a href="#" onclick="deleteAccount(${account.idAccount})"
...
<script>
    function deleteAccount(id) {
        let showMessage = confirm("Do you want to delete this Account ?");
        if (showMessage) {
