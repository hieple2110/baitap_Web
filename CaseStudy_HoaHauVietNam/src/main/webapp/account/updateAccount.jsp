            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="x_content">
                            <a href="/listAccount"><span class="section"><small>Back List Account</small></span></a>
                            <form action="/updateAccount" method="post">
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" name="id"
                                               value="${account.idAccount}" type="hidden" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">User Name<span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="5" name="user"
                                               value="${account.userName}" type="text" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" name="email"
                                               value="${account.email}" type="email" required="required"/>
                                    </div>
                                </div>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="3" name="decentralization"
                                               value="${account.decentralization}" type="email" required="required"/>
                                    </div>
                                </div>
