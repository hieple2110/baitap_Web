            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="x_content">
                            <a href="/listCategory"><span class="section"><small>Back List</small></span></a>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" name="id"
                                               value="${category.idCategory}" type="hidden" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="3" name="name"
                                               value="${category.nameCategory}" type="text" required="required"/>
                                    </div>
                                </div>
                                <div class="ln_solid">
