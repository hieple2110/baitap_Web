                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped jambo_table bulk_action">
                                        ...
                                        <tr class="headings">
                                            ...
                                            <th class="column-title">Short Content</th>
                                        ...
                                        <c:forEach var="posts" items="${listPosts}">
                                            <tr class="even pointer">
                                                ...
                                                <td>
                                                    <a href="/viewPosts?idPosts=${posts.idPosts}"><i
                                                            style="color: #6ce26c" class="fa fa-eye"></i> || </a>
                                                    <a href="/updatePosts?idPosts=${posts.idPosts}"><i
                                                            style="color: #007bff"
                                                            class="fa fa-cogs"></i> || </a>
                                                    <a href="#" onclick="deletePosts(${posts.idPosts})"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Create Posts</h4>
                        </div>
                        <div class="modal-body">
                            <form action="/addPosts" method="post">
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Short Content<span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Full Content<span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
...
<script>
    function deletePosts(id) {
        let showMessage = confirm("Do you want to delete this Nation ?");
        if (showMessage) {
            alert("Delete Nation successfully!")
            window.location = "/deletePosts?id=" + id;
        } else {
        }
    }
</script>
