...
<section class="site-section">
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-6">
                <h2 class="mb-4">Tin tức: Thí sinh</h2>
            </div>
        </div>
        <div class="row blog-entries">
            ...
            <div class="col-md-12 col-lg-8 main-content">
                ...
                <div class="row mb-5 mt-5">
                    <c:forEach items="${listPostMiss}" var="postsMiss">
                        <div class="col-md-12">
                            <div class="post-entry-horzontal">
                                <a href="/viewPostsDisplay?idPosts=${postsMiss.idPosts}">
                                    <div class="image element-animate" data-animate-effect="fadeIn"
                                         style="background-image: url('${postsMiss.image}');"></div>
                                    <span class="text">
                                         <div class="post-meta">
                                             <span class="category">Travel</span>
                                             <span class="mr-2">${postsMiss.date}</span> &bullet;
                                            <span class="ml-2"><span class="fa fa-comments"></span> 3</span>
                                         </div>
                                        <c:set var="title" value="${postsMiss.title}"/>
