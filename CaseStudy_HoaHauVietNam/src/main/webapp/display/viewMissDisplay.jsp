...
<head>
    ...
    <jsp:useBean id="item" class="com.hiep.dao.MissDao" scope="request"/>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="row blog-entries">
            <div class="col-md-12 col-lg-8 main-content">
                <h1 class="mb-4">Thông Tin <a href="/listMissDisplay">Thí Sinh</a></h1>
                <div class="post-meta">
                    <span class="category">Trang chủ</span>
                    ...
                    <div class="container">
                        ...
                        <form class="form-horizontal" action="#">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  value="${miss.nameMiss}" placeholder="Enter email" name="email">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" >Ngày Sinh:</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control"  value="${miss.dateOfBirth}"placeholder="Enter password" name="pwd">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" >Nghề Nghiệp:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="${miss.job}"placeholder="Enter password" name="pwd">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" >Địa chỉ:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  value="${miss.address}"placeholder="Enter password" name="pwd">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" >Tỉnh Thành</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="${miss.province.nameProvince}"placeholder="Enter password" name="pwd">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" >Dân tộc:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  value="${miss.nation.nameNation}"placeholder="Enter password" name="pwd">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" >Học Vấn:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  value="${miss.education.nameEducational}"placeholder="Enter password" name="pwd">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2">Ảnh:</label>
                                <div class="col-sm-10">
                                   <img style="width: 100%;height: 30rem;object-fit: cover;object-position: top;border-radius: 2%;" src="<c:out value="${miss.image}"/> ">
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <c:forEach items="${listActivities}" var="action">
                                <a href="/viewPostsDisplay?idPosts=${posts.idPosts}">
                                    <img style="width: 90%;height: 11rem;object-fit: cover;" src="${action.image}"
                                         src="${action.image}" alt="Image placeholder" class="mr-4">
                                    <div class="text">
                        ...
                        <div class="post-entry-sidebar">
                            <ul>
                                <c:forEach items="${listPostsTop3}" var="top3">
                                    <li>
                                        <a href="/viewPostsDisplay?idPosts=${posts.idPosts}">
                                            <img style=" width: 15rem; height: 5rem; object-fit: cover;"
                                                 src="${top3.image}" alt="Image placeholder" class="mr-4">
                                            <div class="text">
                                                <c:set var="title" value="${top3.title}"/>
