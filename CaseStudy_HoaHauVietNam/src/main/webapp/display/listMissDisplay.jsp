...
<section class="site-section">
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-6">
                <h2 class="mb-4">Danh sách Thí Sinh Đăng Ký</h2>
            </div>
        </div>
                                        ...
                                        <table class="table table-striped jambo_table bulk_action">
                                            ...
                                            <c:forEach var="miss" items="${listMiss}">
                                                <tr class="even pointer">
                                                    <td>
                                                        <a href="/viewMissDisplay?idMiss=${miss.idMiss}">
                                                        <img src="<c:out value="${miss.image}" />" height="100px"
                                                             width="120px"></a></td>
                                                    <td><c:out value="${miss.nameMiss}"/></td>
                                                    <td><c:out value="${miss.dateOfBirth}"/></td>
                            ...
                            <div class="clearfix">
                                <ul class="pagination">
                                    <c:forEach begin="1" end="${item.numberPage}" var="item">
                                        <li class=page-item>
                                            <a href="/listMissDisplay?index=${item}" class="page-link">${item}</a>
                                        </li>
                                    </c:forEach>
                                </ul>
                            </div>
