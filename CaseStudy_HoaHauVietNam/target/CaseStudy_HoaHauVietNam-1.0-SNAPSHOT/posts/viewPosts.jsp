            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="x_content">
                            <a href="/listPosts">
                                <button type="button" class="btn btn-info">Come back list Posts</button>
                            </a>
                            <form action="/viewPosts" method="post">
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-1 col-sm-1  label-align"><span
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-1 col-sm-1  label-align">Short Content<span
                                            class="required"></span></label>
                                    <div class="col-md-11 col-sm-11">
                                        ${posts.shortContent}
                                    </div>
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-1 col-sm-1  label-align"> Full Content<span
                                            class="required"></span></label>
                                    <div class="col-md-11 col-sm-11">
                                        ${posts.fullContent}
                                    </div>
