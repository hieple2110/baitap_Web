            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="x_content">
                            <a href="/listPosts"><span class="section"><small>Back List Post</small></span></a>
                            <form action="/updatePosts" method="post">
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" name="id"
                                               value="${posts.idPosts}" type="hidden" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Title<span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="3" name="title"
                                               value="${posts.title}" type="text" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
