            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="x_content">
                            <a href="/listMiss">
                                <button type="button" class="btn btn-info">Come back</button>
                            </a>
                            <form action="/viewMiss" method="post">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" name="name"
                                               value="${miss.nameMiss}" type="text" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Job<span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" name="province"
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" name="province"
                                               value="${miss.province.getNameProvince()}" type="text"
                                               required="required"/>
                                  </div>
                                </div>
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Nation<span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                    <input class="form-control" data-validate-length-range="6" name="nation"
                                               value="${miss.nation.getNameNation()}" type="text" required="required"/>
                                    </div>
                                </div>

                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Education<span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" name="nation"
                                               value="${miss.education.nameEducational}" type="text" required="required"/>
                                    </div>
                                </div>
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Image<span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <img style="border-radius: 2%;height: 45%;width: 60%;"
                                             src="<c:url value="${miss.image}"/> ">
                                    </div>
                                </div>
                            </form>
                        </div>
