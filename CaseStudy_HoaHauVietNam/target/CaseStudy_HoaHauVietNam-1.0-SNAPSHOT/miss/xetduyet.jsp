            ...
            <div class="">
                <div class="page-title">
                    ...
                    <div class="title_left">
                     <a href="/listMiss">   <button type="button" class="btn btn-success" >
                           Back List Miss
                        </button>
                     </a>
                    </div>
                                    ...
                                    <table class="table table-striped jambo_table bulk_action">
                                        ...
                                        <c:forEach var="miss" items="${listMiss}">
                                            <tr class="even pointer">
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${miss.status=='Chờ duyệt'}">
                                                            <a href="/doApproved?id=${miss.getIdMiss()}"> <span class="status text-warning ">&bull;</span>
                                                                Chờ duyệt</a>
                                                        </c:when>
                                                        <c:when test="${miss.status=='Đã duyệt'}">
                                                            <a href="/doApproved?id=${miss.getIdMiss()}"> <span class="status text-success ">&bull;</span>
                                                                Đã duyệt</a>
                                                        </c:when>
                                                        <c:when test="${miss.status=='Bị loại'}">
                                                            <a href="/doApproved?id=${miss.getIdMiss()}"><span class="status text-danger ">&bull;</span>
                                                                Bị loại</a>
                                                        </c:when>
                                                    </c:choose>
                                                </td>
