                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            ...
                            <li><a href="/listCategory"><i class="fa fa-desktop"></i>Quản lý Tỉnh thành</a>
                            </li>
                                    ...
                                    <table class="table table-striped jambo_table bulk_action">
                                        ...
                                        <c:forEach var="category" items="${listCategory}">
                                            <tr class="even pointer">
                                                ...
                                                <td>
                                                    <a href="/updateCategory?idCategory=${category.idCategory}"><i
                                                            style="color: #007bff"
                                                            class="fa fa-cogs"></i> || </a>
                                                    <a href="#" onclick="deleteCategory(${category.idCategory})"
                        ...
                        <div class="modal-body">
                            <form action="/addCategory" method="post">
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Name Category<span
