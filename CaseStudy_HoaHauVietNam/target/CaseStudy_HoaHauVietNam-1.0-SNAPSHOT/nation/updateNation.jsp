            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="x_content">
                            <a href="/listNation"><span class="section"><small>Back List Nation</small></span></a>
                            <form action="/updateNation" method="post">
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align"><span
                                            class="required"></span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" name="id"
                                               value="${nation.idNation}" type="hidden" required="required"/>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="3" name="name"
                                               value="${nation.nameNation}" type="text" required="required"/>
                                    </div>
                                </div>
                                <div class="ln_solid">
