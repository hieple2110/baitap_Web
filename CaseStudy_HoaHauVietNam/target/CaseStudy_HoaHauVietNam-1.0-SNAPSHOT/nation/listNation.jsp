                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped jambo_table bulk_action">
                                        ...
                                        <tr class="headings">
                                            ...
                                            <th class="column-title">Name Nation</th>
                                        ...
                                        <c:forEach var="nation" items="${listNation}">
                                            <tr class="even pointer">
                                                <td><c:out value="${nation.idNation}"/></td>
                                                <td><c:out value="${nation.nameNation}"/></td>
                                                <td>
                                                    <a href="/viewNation?idNation=${nation.idNation}"><i
                                                            style="color: #6ce26c" class="fa fa-eye"></i> || </a>
                                                    <a href="/updateNation?idNation=${nation.idNation}"><i
                                                            style="color: #007bff"
                                                            class="fa fa-cogs"></i> || </a>
                                                    <a href="#" onclick="deleteNation(${nation.idNation})"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Create Nation</h4>
                        </div>
                        <div class="modal-body">
                            <form action="/addNation" method="post">
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Name Nation<span
...
<script>
    function deleteNation(id) {
        let showMessage = confirm("Candidates will be deleted if their ethnicity is deleted.Do you want to delete this Nation ?");
        if (showMessage) {
            alert("Delete Nation successfully!")
            window.location = "/deleteNations?id=" + id;
        } else {
        }
    }
</script>
