...
<head>
    ...
    <jsp:useBean id="item" class="com.hiep.dao.ProvinceDao" scope="request"/>
</head>
<body class="nav-md">
            ...
            <div class="">
                ...
                <div class="row" style="display: block;">
                    <div class="col-md-12 col-sm-12  ">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped jambo_table bulk_action">
                                        ...
                                        <tr class="headings">
                                            ...
                                            <th class="column-title">Name Province</th>
                                        ...
                                        <c:forEach var="province" items="${listProvince}">
                                            <tr class="even pointer">
                                                <td><c:out value="${province.idProvince}"/></td>
                                                <td><c:out value="${province.nameProvince}"/></td>
                                                <td>
                                                    <a href="/viewProvince?idProvince=${province.idProvince}"><i
                                                            style="color: #6ce26c" class="fa fa-eye"></i> || </a>
                                                    <a href="/updateProvince?idProvince=${province.idProvince}"><i
                                                            style="color: #007bff"
                                                            class="fa fa-cogs"></i> || </a>
                                                    <a href="#" onclick="deleteProvince(${province.idProvince})"
                        ...
                        <div class="clearfix">
                            <ul class="pagination">
                                <c:forEach begin="1" end="${item.numberPage}" var="item">
                                    <li class=page-item>
                                        <a href="/pageProvince?index=${item}" class="page-link">${item}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
                        ...
                        <div class="modal-body">
                            <form action="/addProvince" method="post">
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Name province<span
...
<script>
    function deleteProvince(id) {
        let showMessage = confirm("When you do delete this Province, that related the Miss will be deleted." +
            "Do you want to delete this Province ?");
        if (showMessage) {
            alert("Delete Province successfully!")
            window.location = "/deleteProvince?id=" + id;
        } else {
        }
    }
</script>
